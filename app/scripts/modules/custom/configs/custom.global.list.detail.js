/**
 * @ngdoc function
 * @name ngmReportHubApp.controller:CustomListGlobalDetailCtrl
 * @description
 * # CustomListGlobalDetailCtrl
 * Controller of the ngmReportHub
 */
angular.module('ngmReportHub')
    .controller('CustomListGlobalDetailCtrl', ['$scope', '$location', '$route', 'ngmAuth', 'ngmData', 'ngmUser', '$translate', '$filter', '$rootScope', function ($scope, $location, $route, ngmAuth, ngmData, ngmUser, $translate, $filter, $rootScope) {
        this.awesomeThings = [
            'HTML5 Boilerplate',
            'AngularJS',
            'Karma'
                ...
                $scope.model = {
                    ...
                    header: {
                        ...
                        title: {
                            ...
                            title: $route.current.params.id === 'new' ?'New Global List': "List Detail"
                        },
                        subtitle: {
                            'class': 'col s12 m12 l12 report-subtitle hide-on-small-only',
                            title: $route.current.params.id === 'new'? 'New List for Global List' : 'Detail'
                        },
                        // download: {
                    ...
                    rows: [{
                        columns: [{
                            ...
                            widgets: [{
                                ...
                                style: 'padding: 20px;',
                                config: {
                                    html: '<a class="btn-flat waves-effect waves-teal left hide-on-small-only" href="#/custom/config/global/"><i class="material-icons left">keyboard_return</i> Back </a>'
                                }
                            }]
                        }]
                    }, 
