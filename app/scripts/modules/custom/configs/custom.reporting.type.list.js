/**
 * @ngdoc function
 * @name ngmReportHubApp.controller:CustomReportingTypeListCtrl
 * @description
 * # CustomReportingTypeListCtrl
 * Controller of the ngmReportHub
 */
angular.module('ngmReportHub')
    .controller('CustomReportingTypeListCtrl', ['$scope', '$location', '$route', 'ngmAuth', 'ngmData', 'ngmUser', '$translate', '$filter', '$rootScope', function ($scope, $location, $route, ngmAuth, ngmData, ngmUser, $translate, $filter, $rootScope) {
        this.awesomeThings = [
            'HTML5 Boilerplate',
            'AngularJS',
            'Karma'
        ...
        $scope.list = {
            ...
            // init
            init: function () {
                $scope.list.title = 'Reporting Type Lists | ' + $route.current.params.report_type_id;
                $scope.model = {
                    ...
                    header: {
                        ...
                        subtitle: {
                            ...
                            title: 'Reporting Type List ' + $route.current.params.report_type_id
                        },
                    },
                    menu: [],
                    rows: [{
                        columns: [{
                            ...
                            widgets: [{
                                ...
                                style: 'padding: 20px;',
                                config: {
                                    newUrl: '#/custom/config/reporting-type-detail/' + $route.current.params.report_type_id + '/new',
                                    report_type_id: $route.current.params.report_type_id,
                                    templateUrl: '/scripts/widgets/ngm-html/template/custom.reporting.type.list.btn.html'
                                }
                            }]
                        }]
                    }, {
