/**
 * @name ngmReportHub.factory:ngmCustomDownloads
 * @description
 * # ngmCustomDownloads
...
angular.module('ngmReportHub')
    .factory('ngmCustomDownloads', ['$http', '$location', '$filter', '$timeout', 'ngmAuth', 'ngmCustomLists',
        function ($http, $location, $filter, $timeout, ngmAuth, ngmCustomLists) {

            var ngmCustomDownloads = {

                downloadPopulationsLists: function (project, start_date, end_date) {

                    let lists = ngmCustomLists.setLists(project, start_date, end_date, 10);
                ...
                downloadStockLists: function (admin0pcode, warehouses) {
                    ...
                    let lists = ngmCustomLists.getStockLists(admin0pcode);
