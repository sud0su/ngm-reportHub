/**
 * @name ngmReportHub.factory:ngmCustomLists
 * @description
 * # ngmCustomLists
                ...
                var ngmCustomLists = {
                    ...
                    setLists: function (project, start_date, end_date, transfers) {
                        ...
                        return {
                            ...
                            // lists
                            units: ngmCustomLists.getUnits(project.admin0pcode),
                            indicators: ngmCustomLists.getIndicators(true),
                            delivery_types: ngmCustomLists.getDeliveryTypes(project.admin0pcode, project.cluster_id),
                            mpc_purpose: ngmCustomLists.getMpcPurpose(),

                            // mpc_delivery_type: ngmCustomLists.getMpcDeliveryTypes(project.admin0pcode),
                            mpc_mechanism_type: ngmCustomLists.getMpcMechanismTypes(project.admin0pcode),
                            transfers: ngmCustomLists.getTransfers(transfers),
                            clusters: ngmCustomLists.getClusters(project.admin0pcode).filter(cluster => cluster.project !== false),
                            projectsclasifications: ngmCustomLists.getProjectClasifications(project.admin0pcode),
                            activity_types: ngmCustomLists.getActivities(project, true, ['activity_type_id'], true, start_date, end_date),
                            activity_descriptions: ngmCustomLists.getActivities(project, true, ['activity_description_id', 'activity_type_id'], true, start_date, end_date),
                            activity_details: ngmCustomLists.getActivities(project, true, ['activity_detail_id', 'activity_description_id', 'activity_type_id'], true, start_date, end_date),
                            activity_indicators: ngmCustomLists.getActivities(project, true, ['indicator_id', 'activity_detail_id', 'activity_description_id', 'activity_type_id'], true, start_date, end_date),
                            projectActivityTypes: ngmCustomLists.getProjectActivityTypes(project),
                            strategic_objectives: ngmCustomLists.getStrategicObjectives(project.admin0pcode, moment(project.project_start_date).year(), moment(project.project_end_date).year()),
                            category_types: ngmCustomLists.getCategoryTypes(),
                            beneficiary_types: ngmCustomLists.getBeneficiaries(moment(project.project_end_date).year(), project.admin0pcode, project.cluster_id),
                            beneficiary_categories: ngmCustomLists.getBeneficiariesCategories(project.admin0pcode),
                            hrp_beneficiary_types: ngmCustomLists.getHrpBeneficiaries(project.admin0pcode, moment(project.project_end_date).year()),
                            // location_groups: ngmCustomLists.getLocationGroups(),
                            currencies: ngmCustomLists.getCurrencies(project.admin0pcode),
                            donors: ngmCustomLists.getDonors(project.admin0pcode, project.cluster_id),
                            organizations: ngmCustomLists.getOrganizations(project.admin0pcode),
                            project_details: ngmCustomLists.getProjectDetails(project.admin0pcode),
                            ...
                            // sites
                            site_implementation: ngmCustomLists.getSiteImplementation(project.admin0pcode, project.cluster_id),
                            site_type: ngmCustomLists.getSiteTypes(project.cluster_id, project.admin0pcode),
                    ...
                    getStockLists: function (admin0pcode) {
                        return {
                            clusters: ngmCustomLists.getClusters(admin0pcode).filter(cluster => cluster.filter !== false && cluster.registration !== false),
                            units: ngmCustomLists.getUnits(admin0pcode),
                            ...
                            stock_targeted_groups: ngmCustomLists.getStockTargetedGroups(),
                            donors: ngmCustomLists.getDonors(admin0pcode, ''),
                            organizations: ngmCustomLists.getOrganizations(admin0pcode),
                    ...
                    getActivities: function (project, filterInterCluster, filterDuplicates, filterActiveDate, start_date, end_date) {
                        ...
                        if (filterActiveDate) {
                            activitiesList = ngmCustomLists.filterActiveDate(activitiesList, start_date, end_date);
                        }

                        // filter duplications by tag
                        if (filterDuplicates) {
                            activities = ngmCustomLists.filterDuplicates(activitiesList, filterDuplicates);
                        }
                    ...
                    getBeneficiaries: function (year, admin0pcode, cluster_id) {
                        ...
                        function excludeSectors(exSectors) {
                            var clone = Object.assign([], ngmCustomLists.all_sectors);
                        ...
                        // default
                        var beneficiaries = [{
                            cluster_id: ngmCustomLists.all_sectors,
                        ...
                        if (admin0pcode === 'CB') {
                            ...
                            beneficiaries = [{
                                ...
                                cluster_id: ngmCustomLists.all_sectors_minus_wash_education,
                        ...
                        if (admin0pcode === 'COL') {
                            ...
                            var beneficiaries = [
                                ...
                                {
                                    cluster_id: ngmCustomLists.all_sectors_col,
                        ...
                        if (admin0pcode === 'ET') {
                            ...
                            // beneficiaries
                            beneficiaries = [{
                                cluster_id: ngmCustomLists.all_sectors_minus_esnfi,
                                beneficiary_type_id: 'idps',
                                beneficiary_type_name: 'IDPs'
                            }, {
                                cluster_id: ngmCustomLists.all_sectors,
                    ...
                    getSiteImplementation: function (admin0pcode, cluster_id) {
                        ...
                        if (admin0pcode === 'AF') {
                            site_implementation = [{
                                cluster_id: ngmCustomLists.all_sectors_minus_protection,
                    ...
                    getSiteTypes: function (cluster_id, admin0pcode) {
                        ...
                        if (admin0pcode === 'CB') {
                            site_types = [{
                                ...
                                cluster_id: ngmCustomLists.all_sectors_minus_health,
                                site_type_id: 'ward',
                                site_type_name: 'Ward'
                            }, {
                                cluster_id: ngmCustomLists.all_sectors_minus_health,
                                ...
                                cluster_id: ngmCustomLists.all_sectors_minus_wash_health,
                                ...
                                cluster_id: ngmCustomLists.all_sectors_minus_wash_health_smsd,
                                site_type_id: 'nutrition_center',
                                site_type_name: 'Nutrition Center'
                            }];
                        }
                    ...
                    // Custom Config Atrribute
                    getCustomReportTypeAttributeBeneficiaries:function(report_type_id){
                        attribute= {
                            winterization :{
                                planned_families: 0,
                        ...
                        return attribute[report_type_id] ? attribute[report_type_id] :{};
                    },
                    getCustomReportType: function (report_type_id){
                        report_type = {
                            winterization:{
                        ...
                        return report_type[report_type_id] ? report_type[report_type_id]:{};
                    },
                    getAtrributeTotalBeneficiaries: function (report_type_id){
                        total = {
                            winterization: 'total_package_families'
                        }
                        return total[report_type_id] ? total[report_type_id] : '';
                    }
                };

                // return
                return ngmCustomLists;
