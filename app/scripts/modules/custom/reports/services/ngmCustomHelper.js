/**
 * @name ngmReportHub.factory:ngmCustomHelper
 * @description
 * # ngmCustomHelper
...
angular.module('ngmReportHub')
    .factory('ngmCustomHelper',
        ['$location',
            ...
            'ngmCustomLists',
            'ngmCustomConfig',
            'ngmCustomLocations', '$translate', '$filter',
            function ($location,
                $q,
                $http,
                $filter,
                ...
                var ngmCustomHelper = {
                    ...
                    //                 ngmCustomHelper.compileActivityType(project, lists);
                    ...
                    //     // set hrp code
                    //     project.project_hrp_code = ngmCustomHelper.getProjectHrpCode(project);
                    ...
                    getNewCustomProject: function (user,report_type_id) {
                    ...
                    //         }
                    //     });
                    //     ngmCustomHelper.compileStrategicObjectives(project, lists);
                    //     ngmCustomHelper.compileActivityType(project, lists);
                    // },
