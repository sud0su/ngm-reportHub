/**
 * @ngdoc function
 * @name ngmReportHubApp.controller:CustomReportsListCtrl
 * @description
 * # CustomReportsListCtrl
 * Controller of the ngmReportHub
 */
angular.module('ngmReportHub')
    .controller('CustomReportsListCtrl', ['$scope', '$route', '$location', '$anchorScroll', '$timeout', 'ngmAuth', 'ngmData', 'ngmUser', '$translate', '$filter', 'ngmCustomConfig', function ($scope, $route, $location, $anchorScroll, $timeout, ngmAuth, ngmData, ngmUser, $translate, $filter, ngmCustomConfig) {
        this.awesomeThings = [
            'HTML5 Boilerplate',
            'AngularJS',
            'Karma'
        ...
        $scope.report = {
            ...
            getHeaderHtml: function () {
                var html = '<div class="row">'
                    ...
                    + '<a class="btn-flat waves-effect waves-teal" href="#/custom/custom-projects-summary/' + $scope.report.project.id + '">'
            ...
            getReportTemplate: function () {
                var tmpl = '/scripts/widgets/ngm-list/template/custom_report.html';
                return tmpl;
            },
            ...
            getReportUrl: function () {
                // report
                var report_url = '#/custom/custom-project-report';
                return report_url;
            },
                        ...
                        columns: [{
                            ...
                            widgets: [{
                                ...
                                config: {
                                    ...
                                    request: {
                                        method: 'POST',
                                        url: ngmAuth.LOCATION + '/api/custom/report/getReportsList',
                                        data: {
        ...
        ngmData.get({
            ...
            // assign data
            $scope.report.setReportList(data);
        });
