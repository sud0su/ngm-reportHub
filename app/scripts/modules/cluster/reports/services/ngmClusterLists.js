		...
		var ngmClusterLists = {
			...
			setClusterLists: function( user ) {
				...
				var requests = {
					...
					getDonors: {
						method: 'GET',
						url: ngmAuth.LOCATION + '/api/cluster/list/donorsnew?admin0pcode=' + user.admin0pcode
					},
					...
					getBeneficiaryTypes: {
						method: 'GET',
						url: ngmAuth.LOCATION + '/api/cluster/list/beneficiarytypes?admin0pcode=' + user.admin0pcode
					}
				...
				if ( !localStorage.getObject( 'lists' ) ) {
					...
					if (user.roles.length > 1) {
						...
						if (max_role === 'HQ' || max_role === 'HQ_ORG' || max_role === 'REGION_ORG' || max_role === 'REGION' || max_role === 'SUPERADMIN') {
							...
							// get all donors if superadmin
							if(max_role === 'SUPERADMIN'){
								var getDonorsAll= {
									method: 'GET',
									url: ngmAuth.LOCATION + '/api/cluster/list/donorsnew?admin0pcode=ALL'
								}
								requests.getDonors = getDonorsAll;
							}
							...
							if (max_role === 'SUPERADMIN') {
								var getBeneficiaryTypesAll = {
									method: 'GET',
									url: ngmAuth.LOCATION + '/api/cluster/list/beneficiarytypes'
								}
								requests.getBeneficiaryTypes = getBeneficiaryTypesAll;
							}
						}
					}
					// send request
					$q.all([
						...
						$http(requests.getBeneficiaryTypes)
							...
							var lists = {
								...
								beneficiaryTypeList: results[11].data
			...
			getDonors: function( admin0pcode, cluster_id ) {
				...
				// 		{ project_donor_id: 'echo', project_donor_name: 'ECHO' },
				// 		{ project_donor_id: 'ehf', project_donor_name: 'EHF' },
				// 		{ project_donor_id: 'ercs', project_donor_name: 'ERCS' },
				// 		{ project_donor_id: 'european_union', project_donor_name: 'European Union' },
				// 		{ project_donor_id: 'fao', project_donor_name:'FAO' },
				// 		{ project_donor_id: 'finland', project_donor_name:'Finland' },
				// 		{ project_donor_id: 'france', project_donor_name:'France' },
				// 		{ project_donor_id: 'german_foreign_ministry', project_donor_name: 'German Foreign Ministry' },
				// 		{ project_donor_id: 'global_fund', project_donor_name: 'Global Fund' },
				// 		{ project_donor_id: 'government_of_ethiopia', project_donor_name: 'Government of Ethiopia' },
				// 		{ project_donor_id: 'icrc', project_donor_name: 'ICRC' },
				// 		{ project_donor_id: 'ifrc', project_donor_name: 'IFRC' },
				// 		{ project_donor_id: 'iom', project_donor_name: 'IOM' },
				// 		{ project_donor_id: 'irish_aid', project_donor_name: 'IrishAid' },
				...
				// 		},
				// 		{
				// 			"project_donor_id": "european_union",
				// 			"project_donor_name": "European Union"
				// 		},
				// 		{
				// 			"project_donor_id": "finland",
				// 			"project_donor_name": "Finland"
				// 		},
				// 		{
				...
				// 		},
				// 		{
				// 			"project_donor_id": "irish_aid",
				// 			"project_donor_name": "IrishAid"
				// 		},
				// 		{
				// 			"project_donor_id": "italy",
				// 			"project_donor_name": "Italy"
				// 		},
				// 		{
				// 			"project_donor_id": "netherlands",
				// 			"project_donor_name": "Netherlands"
				// 		},
				// 		{
				...
				// 		},
				// 		{
				// 			"project_donor_id": "sdc",
				// 			"project_donor_name": "SDC"
				// 		},
				// 		{
				// 			"project_donor_id": "shf",
				// 			"project_donor_name": "SHF"
				// 		},
				// 		{
				// 			"project_donor_id": "sida",
				// 			"project_donor_name": "SIDA"
				// 		},
				// 		{
				...
				// 		},
				// 		{
				// 			"project_donor_id": "wfp",
				// 			"project_donor_name": "WFP"
				// 		},
				// 		{
			...
			getBeneficiaries: function( year, admin0pcode, cluster_id ,start,end ) {
				...
				// 		$http({
				// 			method: 'GET',
				// 			url: ngmAuth.LOCATION + '/api/cluster/list/beneficiarytypes?admin0pcode=' + admin0pcode
				// 		}).then(function (result) {
				// 			var beneficiaries2 = result.data.filter(b => (b.admin0pcode === admin0pcode));
				// 			if (!beneficiaries2.length) {
				// 				beneficiaries2 = result.data.filter(b => b.admin0pcode === 'ALL');
				// 			}
				// 			// console.log(beneficiaries2)
				// 			var beneficiaries_date = ngmClusterLists.filterActiveDate(beneficiaries2, start, end);
				// 			console.log(beneficiaries_date)
				// 			lists.beneficiary_types = beneficiaries_date
				// 	})
				// }

				var beneficiaries, beneficiaries_filterby_admin0pcode, beneficiaries_date = [];
				beneficiaries = ngmLists.getObject('lists').beneficiaryTypeList;
				
				// filter by admin0pcode
				beneficiaries_filterby_admin0pcode = beneficiaries.filter(b => (b.admin0pcode === admin0pcode));
				if (!beneficiaries_filterby_admin0pcode.length) {
					beneficiaries_filterby_admin0pcode = beneficiaries.filter(b => b.admin0pcode === 'ALL');
				}
			...
			getSiteImplementation: function( admin0pcode, cluster_id ){
				...
				// NG GBV
					...
					site_implementation = [
						...
						{
							cluster_id: ngmClusterLists.all_sectors,
							"site_implementation_id": "hfc",
							"site_implementation_name": "Health Care Facility"
						},
						{
							cluster_id: ngmClusterLists.all_sectors,
							"site_implementation_id": "mobile_health_unit_ambulance",
							"site_implementation_name": "Mobile Health Unit / Ambulance"
						},
						{
							cluster_id: ngmClusterLists.all_sectors,
							"site_implementation_id": "orp_ctc",
							"site_implementation_name": "ORP/CTC"
						}
					];
				}
