		...
		function(
			...
			$scope.project = {
				...
				addBeneficiaryFromFile: function (beneficiary, $indexFile) {
					...
					if (beneficiary.beneficiary_type_name && ngmClusterBeneficiaries.form[0][$scope.project.definition.target_beneficiaries.length - 1]['beneficiary_type_id']) {
						selected_beneficiary_type = $filter('filter')(ngmClusterBeneficiaries.form[0][$scope.project.definition.target_beneficiaries.length - 1]['beneficiary_type_id'], { beneficiary_type_name: beneficiary.beneficiary_type_name }, true);
