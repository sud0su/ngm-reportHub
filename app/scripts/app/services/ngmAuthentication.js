...
angular.module('ngmReportHub')
	...
	.constant( 'ngmPermissions', [{
			...
			TEAM_MENU: [],
			LIST_ADMIN:false,
			LIST_ADMIN_RESTRICTED:[],
			// edit only active or not in country
			EDIT_ORG_LIST_PARTIAL: false,
			// edit modify, delete, 
			EDIT_ORG_LIST_FULL:false,
			VALIDATE: false,
			MULTICOUNTRY: false,
			LEVEL: 0,
		...
		},
		{
			...
			LIST_ADMIN:true,
			LIST_ADMIN_RESTRICTED: ['cluster_id', 'admin0pcode'],
			// edit only active or not in country
			EDIT_ORG_LIST_PARTIAL: true,
			// edit modify, delete, 
			EDIT_ORG_LIST_FULL:false,
		...
		},
		{
			...
			LIST_ADMIN:true,
			LIST_ADMIN_RESTRICTED: ['admin0pcode'],
			// edit only active or not in country
			EDIT_ORG_LIST_PARTIAL: false,
			// edit modify, delete, 
			EDIT_ORG_LIST_FULL:false,
